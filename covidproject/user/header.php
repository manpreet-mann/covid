                  ...
                  <nav class="site-navbar">
                     <ul>
                        ...
                        ?>
                           ...
                           <!-- <li><a href="login.php" style="background-color: rgb(237, 36, 46); font-size:20px; " class="btn text-light">Login</a></li> -->
                           <li><a href="view_appoint.php" style="background-color: rgb(237, 36, 46); font-size:20px" class="btn text-light">My Test</a></li>
                        ...
                        ?>
                           ...
                           <li><a href="symptoms.php" style="background-color: rgb(237, 36, 46); font-size:20px" class="btn text-light">Symptoms</a></li>
                           <li><a href="prevention.php" style="background-color: rgb(237, 36, 46); font-size:20px" class="btn text-light">Prevention</a></li>
                           <li><a href="customer.php" style="background-color: rgb(237, 36, 46); font-size:20px; " class="btn text-light">Register</a>
                        </li>
                        <?php
                        }
                        ?>
